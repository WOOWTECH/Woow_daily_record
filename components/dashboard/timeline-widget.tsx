...
import { COLOR_THEMES, ICONS, type Log } from "@/lib/constants";
        ...
        <GlassCard className="min-h-[600px] p-8">
            ...
            <div className="space-y-4">
                ...
                {!isLoading && filteredLogs.map((log) => {
                    ...
                    return (
                        <div key={log.id} className="group relative flex items-center p-4 bg-brand-gray/30 dark:bg-white/5 rounded-2xl hover:bg-brand-gray/60 dark:hover:bg-white/10 transition-all border border-transparent hover:border-white/10">
                            {/* Time (Left) */}
