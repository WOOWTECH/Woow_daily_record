...
export default function SignupPage() {
    return (
        <div className="flex min-h-screen items-center justify-center p-4 relative">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-brand-soft-yellow/20 rounded-full blur-[100px] animate-pulse" />
            ...
            <GlassCard className="w-full max-w-md p-10 relative z-10 !shadow-[0_20px_50px_rgba(0,0,0,0.1)]">
                <div className="text-center mb-8">
                    ...
                    <p className="text-brand-deep-gray text-sm">Join Home OS to manage your family</p>
                </div>
                ...
                <form className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        <button formAction={signup} className="w-full rounded-xl bg-brand-blue py-3.5 text-sm font-bold text-white hover:bg-brand-blue/90 hover:shadow-lg hover:shadow-brand-blue/30 hover:-translate-y-0.5 transition-all">
                            Sign Up
                        </button>
                        <p className="text-center text-sm text-gray-500">
                            Already have an account?{' '}
                            <a href="/login" className="text-brand-blue hover:underline font-semibold">
                                Log In
                            </a>
                        </p>
                    </div>
